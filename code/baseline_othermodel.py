...
def train():
    ...
    filename = config.get('othermodel','name')
    batch = int(config.get('othermodel','batch'))
    ...
    # dataset_train= pd.concat([dataset_train,jap,eng],ignore_index=True).sample(frac=1, random_state=SEED)
